...
class GridEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.x = [140, 220, 300, 380, 460, 140, 300, 460]  # 中心位置x坐标
        self.y = [250, 250, 250, 250, 250, 150, 150, 150]  # 中心位置y坐标

        self.terminate_states = dict()  # 终止状态
        self.terminate_states[6] = 1  # 状态6进入终止状态
        self.terminate_states[7] = 1
        self.terminate_states[8] = 1

        self.actions = ['n', 'e', 's', 'w']  # 动作空间
        self.action_space = ['n', 'e', 's', 'w']  # 动作空间
...
if __name__ == "__main__":
    ...
    gym.envs.register(
        id='GridWorld-v0',
        entry_point='my-gym.grid_mdp:GridEnv',
